...
#   appears in a string. 
# 
# For example, the following code counts the number of times 'row' appears in a 
#   string:
...
with open(filename) as f:
    ...
    print(contents.lower().count("dick"))

# there are 20139 "the" and 13314 "the "
# also there are 89 "dicks" in Moby Dick