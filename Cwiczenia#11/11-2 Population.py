...
import unittest
from test_cities import CityTestCase
unittest.main() # returned failed test - error TypeError missing 1 positional ar

# after making population paramater optional test passes
