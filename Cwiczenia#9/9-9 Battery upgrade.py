...
# 
# This method should check the battery size and set the capacity to 100 if it 
#   isn’t already. 
# 
...
class Battery:
    ...
    def upgrade_battery(self):
        """Initialize battery upgrade if size is lower than 100kwh."""
        if self.battery_size < 100:
            self.battery_size = 100
            print("Upgraded your car battery to 100kWh!")
        else:
